...
public class NowPlayingSearchTest {
    ...
    public void nowPlayingSearchTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editText1),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Venom"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.Results_MovieName), withText("Title: Venom"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        textView2.check(matches(withText(containsString("Venom"))));
